...
#define STARTUP_RAMP_PWM	0.7*PWM_TOP //Most motors should work with 30%
...
#define STARTUP_RLOCK		100 //How many clock overflows to lock the rotor for (1 ovf = 4ms)
#define STARTUP_TICKS_BEGIN	60000 //Larger/heavier motors need larger values
#define STARTUP_TICKS_END	20000 //Startup complete once commutation rate is this many clock ticks
...
#define STARTUP_STABILISE	200 //How many commutations to loop for once ramp has completed